...
class AnariConventions(ConventionsBase):
    @property
    def null(self):
    ...
    def warning_comment(self):
        ...
        return '// WARNING: DO NOT MODIFY! This file is automatically generated from the an.xml registry'
    ...
    def api_name(self, spectype='api'):
        """Return API or specification name for citations in ref pages.ref
           ...
           spectype is the spec this refpage is for: 'api' is the ANARI API
    ...
    def specURL(self, spectype='api'):
        ...
        """
        return 'https://www.khronos.org/registry/anari/specs/1.0/html/anspec.html'
    ...
    def category_requires_validation(self, category):
        ...
        Overridden because ANARI doesn't require "valid" text for basetype in the spec right now."""
    ...
    def valid_flag_bit(self, bitpos):
        """Return True if bitpos is an allowed numeric bit position for
           ...
           ANARI uses 32 bit An*Flags types, and assumes C compilers may
           cause An*FlagBits values with bit 31 set to result in a 64 bit
